...
export default function EditProduct({ product, onCancel, onProductUpdated }: EditProductProps) {
  ...
  return (
    <form onSubmit={handleSubmit} className="mb-8 space-y-4 p-4 bg-gray-100 rounded">
      ...
      <div className="flex space-x-4">
        ...
        <button type="button" onClick={onCancel} className="p-2 bg-gray-500 text-white rounded hover:bg-gray-600">
          Cancel
        </button>
      </div>
    </form>
